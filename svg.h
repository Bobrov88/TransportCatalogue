...
namespace svg
{
    ...
    std::string_view operator*(const Color &color);
    ...
    struct ColorViewer
    {
        ...
        {
            std::string ret{"rgb("};
            ret.append(std::to_string(static_cast<int>(rgb.red)));
            ret.append(",");
            ret.append(std::to_string(static_cast<int>(rgb.green)));
            ret.append(",");
            ret.append(std::to_string(static_cast<int>(rgb.blue)));
            ret.append(")");
            return ret;
        }
        ...
        {
            std::string ret{"rgb("};
            ret.append(std::to_string(static_cast<int>(rgba.red)));
            ret.append(",");
            ret.append(std::to_string(static_cast<int>(rgba.green)));
            ret.append(",");
            ret.append(std::to_string(static_cast<int>(rgba.blue)));
            std::ostringstream oss;
            oss << std::fixed << std::setprecision(1) << rgba.opacity; // Устанавливаем 1 знак после запятой
            ret.append(",");
            ret.append(oss.str());
            ret.append(")");
            return ret;
